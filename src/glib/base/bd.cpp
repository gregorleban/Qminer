...
void ExeStop(const char* MsgCStr, const char* ReasonCStr, const char* CondCStr, const char* FNm,
             const int& LnN)
{
    ...
    if (MsgCStr == NULL) {
        if (CondCStr == NULL) {
            ...
            sprintf(FullMsgCStr, "Execution stopped: %s%s, file %s, line %d", CondCStr,
                    ReasonMsgCStr, FNm, LnN);
        }
    }
    else {
        if (CondCStr == NULL) {
            ...
            sprintf(FullMsgCStr, "Message: %s%s\nExecution stopped: %s, file %s, line %d", MsgCStr,
                    ReasonMsgCStr, CondCStr, FNm, LnN);
        }
    }
